...
HD_PWD='/net/s/lmartin042/S8/verif/EN224-Test-et-verification/2_Hardware/Etape_7/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PGCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PGCD.tcl
