...
HD_PWD='/net/s/lmartin042/S8/verif/EN224-Test-et-verification/2_Hardware/Etape_7/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PGCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PGCD.tcl -notrace
